...
**CLIs**
 * [codex-profiles](https://github.com/ducksss/codex-profiles) - 命名为CODEX_HOME配置文件和ChatGPT桌面窗口具有单独的本地状态，不复制令牌。
 * [shob](https://github.com/shobcoder/shob) - Shob - 一个提供高质量编码和自动化工作的人工智能代理
 * [nika](https://github.com/supernovae-st/nika) - 意图作为代码 | 人工智能的工作流语言。一个文件，4个动词，一个Rust二进制文件。本地优先，任何模型，AGPL-3.0。🦋


**NLP**
 * [markstream-vue](https://github.com/simon-he95/markstream-vue) - 为AI应用程序提供多框架流式Markdown渲染器：Vue/Nuxt、React/Next.js、Svelte和Angular，配备Mermaid、KaTeX、Shiki、Monaco、安全HTML和低抖动更新。
 * [screenpipe](https://github.com/screenpipe/screenpipe) - YC（S26）| 每天全天记录您的屏幕并连接到您的代理。本地、私密、安全。连接到OpenClaw、Hermes代理和100多个应用程序。
 ...
 * [squidgy-prompts](https://github.com/squidgyai/squidgy-prompts) - #chatgpt和语言学习感兴趣？我们刚刚发布了一组开源提示，帮助学习者构建卡组、挖掘句子、纠正语法、玩单词游戏等等。可以单独使用或在@squidgiesapp中使用。
 ...
 * [pandas-ai](https://github.com/gventuri/pandas-ai) - 4、Anthropic、VertexAI）和RAG使数据分析变得对话化。
 ...
 * [quivr](https://github.com/quivrhq/quivr) - 4 turbo、Private、Anthropic、VertexAI、Ollama、LLMs与您的文档（PDF、CSV等）和应用进行交流，您可以与用户共享！这是OpenAI GPTs和ChatGPT的本地和私密替代方案，由检索增强生成技术驱动。
 * [smalltalk](https://github.com/tinystruct/smalltalk) - ChatGPT集成。@tinystruct
 * [maid](https://github.com/mobile-artificial-intelligence/maid) - llama.cpp模型进行交互，并与Ollama和OpenAI模型进行远程交互。
 * [pandas-ai](https://github.com/sinaptik-ai/pandas-ai) - 4、Anthropic、VertexAI）和RAG使数据分析变得对话化。
 ...
 * [nlux](https://github.com/nluxai/nlux) - Javascript库
 ...
 * [LangBot](https://github.com/langbot-app/langbot) - Slack 🧩 集成了ChatGPT、DeepSeek、Dify、n8n、Claude、Google Gemini、xAI、PPIO、Ollama、阿里云百炼、Silic
 ...
 * [conversational-agent-langchain](https://github.com/mfmezger/conversational-agent-langchain) - 使用Cohere、(Azure) OpenAI、Langchain和Langgraph以及Qdrant作为VectorDB的对话代理的FastAPI后端
 ...
 * [GodMode](https://github.com/smol-ai/godmode) - Llama2！我每天使用它20次。
 ...
 * [Q-Bench](https://github.com/q-future/q-bench) - Qwen-VL-Plus + 16 OS MLLMs）低级视觉和视觉质量评估的多模态LLMs（MLLMs）基准。
 ...
 * [searchGPT](https://github.com/michaelthwan/searchgpt) - OpenAI API的有来源引用的搜索引擎。支持网页搜索、文件内容搜索等。
 ...
 * [rikkahub](https://github.com/rikkahub/rikkahub) - RikkaHub是一个支持多个LLM提供商的Android应用程序。
 * [Rankify](https://github.com/datascienceuibk/rankify) - 🔥 Rankify：一个全面的Python工具包，用于检索、重新排序和检索增强生成🔥。我们的工具包集成了40个预检索基准数据集，支持7种以上的检索技术，24种以上的最新重新排序模型，以及多种其他功能。
 ...
 * [dyad](https://github.com/dyad-sh/dyad) - Bolt替代品 🌟 如果你喜欢，请点赞！
 ...
 * [llms-tools](https://github.com/petroivaniuk/llms-tools) - LLMs工具和项目列表
 ...
 * [pipelex](https://github.com/pipelex/pipelex) - Pipelex：开源语言，用于AI代理创建和运行可重复的AI工作流程
 ...
 * [Acontext](https://github.com/memodb-io/acontext) - 一个地方供代理商存储、观察和学习。自学代理商的上下文数据平台，旨在简化上下文工程并提高代理商的可靠性和任务成功率。
 * [SQL-AI-samples](https://github.com/azure-samples/sql-ai-samples) - 使用人工智能和Azure SQL数据库的样本
 * [openai-agents-go](https://github.com/nlpodyssey/openai-agents-go) - 一个轻量级、强大的多代理工作流框架，适用于Go语言。
 ...
 * [langchat](https://github.com/tycoding/langchat) - Claude 等大模型），Java 生态下 AI 大模型产品解决方案，快速构建企业级 AI 知识库、AI 机器人应用
 ...
 * [zen-mcp-server](https://github.com/beehiveinnovations/zen-mcp-server) - 以上所有] 联合运作的力量。
 ...
 * [vllora](https://github.com/vllora/vllora) - 调试您的AI代理
 ...
 * [NeuroGPT](https://github.com/neurogen-dev/neurogpt) - 聊天GPT API
 ...
 * [gpt-tokenizer](https://github.com/niieani/gpt-tokenizer) - GPT-4。具有额外功能的OpenAI的tiktoken端口。
 ...
 * [xpert](https://github.com/xpert-ai/xpert) - Xpert AI是一个为企业提供人工智能代理和数据分析平台，帮助他们做出商业决策的工具。
 ...
 * [spring-chatgpt-sample](https://github.com/azure-samples/spring-chatgpt-sample) - Java堆栈的ChatGPT样本
 ...
 * [consult-omni](https://github.com/armindarvish/consult-omni) - Emacs内置的强大多功能全能搜索
 ...
 * [rewind-for-ai-chats](https://github.com/pme26elvis/rewind-for-ai-chats) - JSON 导入、分析和可分享的总结卡片。
