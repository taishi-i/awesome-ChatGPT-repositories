 ...
 * [awesome-chatgpt-project](https://github.com/xianyu110/awesome-chatgpt-project) - 1. chatGPT registration2. chatGPT finished project organization3. Tips for efficient use of chatGPT4. Training guide ↓ Demo website
 ...
 * [LangBot](https://github.com/langbot-app/langbot) - Slack 🧩 Integrated with ChatGPT、DeepSeek、Dify、n8n、Claude、Google Gemini、xAI、PPIO、Ollama、阿里云百炼、Silic
 ...
 * [chatgpt-conversation-timeline](https://github.com/reborn14/chatgpt-conversation-timeline) - This plugin adds a timeline navigation feature to the conversation pages of ChatGPT, DeepSeek, and Google Gemini, allowing you to easily jump to any message and improve browsing efficiency.
 ...
 * [solon](https://github.com/opensolon/solon) - 🔥 Java enterprise application development framework for full scenario: Restrained, Efficient, Open, Ecologicalll!!! 700% higher concurrency 50% memory savings Startup is 10 times faster. Packing 90% smaller; Compatible with java8 ~ java24. (Replaceable spr
 ...
 * [bob-plugin-openai-translator](https://github.com/nextai-translator/bob-plugin-openai-translator) - Text translation, text polishing, and grammar correction Bob plugin based on OpenAI API, let's welcome a new era without the need for the Tower of Babel together! Licensed under CC BY-NC-SA 4.0
 ...
 * [langchat](https://github.com/tycoding/langchat) - Claude, etc.), Java ecosystem AI large model product solution, quickly build enterprise-level AI knowledge base, AI robot applications.
 ...
 * [vllora](https://github.com/vllora/vllora) - Debugging your AI agents
 * [ai-agents](https://github.com/huangjia2019/ai-agents) - Asynchronous Book: "Hands-on AI Agent Development for Large Model Applications" - These are some very simple introductory examples, focusing on guiding beginners to get started. Currently, the development of LLM is progressing rapidly, and this book is just a brief overview. For more examples and code, you can explore the OpenAI Cookbook and LangChain Example.
 ...
 * [coai](https://github.com/coaidev/coai) - 🚀 Next Generation AI One-Stop Internationalization Solution. 🚀 下一代 AI 一站式 B/C 端解决方案，支持 OpenAI，Midjourney，Claude，讯飞星火，Stable Diffusion，DALL·E，ChatGLM，通义千问，腾讯混元，360 智脑，百川 AI，火山方舟，新必应，Gemini，Moonshot 等模型，支持对话分享，自定义预设，云端同步，模型市场，支持弹性计费和订阅计划模式，支持图片解析，支持联网搜索，支持模型
 ...
 * [airport-access](https://github.com/chatgpt-helper-tech/airport-access) - Netflix, including usage tutorial.
