...
**Chatbots**
 * [chatgpt-finetune-ui](https://github.com/anchen1011/chatgpt-finetune-ui) - 簡單的python WebUI,用于微調ChatGPT (gpt-3.5-turbo)


**CLIs**
 * [SuperSummarizeAI](https://github.com/alexandrevl/supersummarizeai) - 輕鬆地從網頁和YouTube影片中提取,凝縮和剪輯內容, 使用ChatGPT. 將無限的內容流轉化為易於消化的摘要.
 * [minion](https://github.com/mikaelvesavuori/minion) - 开发者在CLI中使用ChatGPT的最簡單,最輕巧的方式.
 * [chai-ruby](https://github.com/rogueocelot/chai-ruby) - cd 在您選擇的終端模擬器中打開 GNOME 檔案目錄


**Reimplementations**
 * [Local-Code-Interpreter](https://github.com/mrgreyfun/local-code-interpreter) - 提供了一個更好的方法,


**NLP**
 * [jekyll-chatgpt-translate](https://github.com/yegor256/jekyll-chatgpt-translate) - 透過ChatGPT自動翻譯 Jekyll頁面:你只需要一個OpenAI API鍵


**Openai**
 * [function-gpt](https://github.com/atinylittleshell/function-gpt) - 這是一本字體圖書館,


**Others**
 * [azurechatgpt](https://github.com/dandinu/azurechatgpt) -  Azure ChatGPT:私人與安全的ChatGPT,
 * [OpenGPT-Business](https://github.com/black-fruit/opengpt-business) - 沒有必要授權!
 * [ChatGPT-fine-tuning](https://github.com/iongpt/chatgpt-fine-tuning) - 訓練微調 ChatGPT 的實用類別
 * [ChatGPT-Next-Web-Pro](https://github.com/vual/chatgpt-next-web-pro) - 基于chatgpt-next-web,增加了中程繪畫功能. 後續會接入stable-diffusion,注冊登录,后台管理,接入知識庫等.
 * [chirp](https://github.com/rogueocelot/chirp) - 接送 ChatGPT 詢問及解答
...
Prompt Engineering | 使用GPT或其他基於提示的模型獲取結構化輸出。加入我們的Discord，了解Prompt-Engineering、LLMs和其他最新研究。
 ...
 * [opening-up-chatgpt.github.io](https://github.com/opening-up-chatgpt/opening-up-chatgpt.github.io) - 請將以下內容翻譯成繁體中文。
Liesenfeld, Andreas, Alianda Lopez和Mark Dingemanse。2023年。“開放ChatGPT：追蹤指導調整文本生成器的開放性、透明度和責任。”在第5屆國際會議上的對話用戶界面。愛因霍芬。doi:10.1145/3571884.3604316。
 ...
 * [gpt4all-colab](https://github.com/camenduru/gpt4all-colab) - 🔥gpt4all（最佳的chatgpt克隆版）在本地運行並在colab教程中 - 到@camenduru的colab -
 ...
 * [vault-ai](https://github.com/pashpashpash/vault-ai) - OP Vault ChatGPT：使用OP Stack（OpenAI + Pinecone Vector Database）為ChatGPT提供長期記憶。使用簡單的React前端上傳自己的自定義知識庫文件（PDF，txt等）。

OP Vault ChatGPT：使用OP Stack（OpenAI + Pinecone Vector Database）為ChatGPT提供長期記憶。使用簡單的React前端上傳自己的自定義知識庫文件（PDF，txt等）。
 ...
 * [automated-interpretability](https://github.com/openai/automated-interpretability) - LLMs 可以解釋其他 LLMs 中的神經元
 ...
 * [C3SQL](https://github.com/bigbigwatermalon/c3sql) - 請將以下內容翻譯成繁體中文。
論文C3的代碼：使用ChatGPT進行零樣本文本到SQL的轉換
 ...
 * [pva-aoai-integration-solution](https://github.com/city-of-kobe/pva-aoai-integration-solution) - 中身不是很重要，但作為地方政府的努力，這很有趣。Azure OpenAI - 這個存儲庫是為了將在神戶市政府中試用ChatGPT的流程等進行解決方案化並公開而創建的。
中身不是很重要，但作為地方政府的努力，這很有趣。Azure OpenAI - 這個存儲庫是為了將在神戶市政府中試用ChatGPT的流程等進行解決方案化並公開而創建的。
 ...
 * [openai-billing-query](https://github.com/woodchen-ink/openai-billing-query) - 單頁面專案，批量可視化查詢openai(chatgpt)餘額，支持顯示總量，已使用，剩餘量，已用比例，到期時間，GPT-4，是否綁卡。
這是一個單頁面專案，可以批量查詢openai(chatgpt)餘額的可視化功能。支持顯示總量、已使用量、剩餘量、使用比例、到期時間、GPT-4以及是否綁定卡片。
 ...
 * [ida_gpt](https://github.com/mayerdaniel/ida_gpt) - 代碼以將＃chatgpt整合到@hexrayssa中，以評論gpt的功能描述並為您重新命名變量和函數名稱。

將＃chatgpt整合到@hexrayssa中的代碼，以評論gpt的功能描述並為您重新命名變量和函數名稱。
 ...
 * [gpt-code-search](https://github.com/wolfia-app/gpt-code-search) - GitHub Action 可以自動上傳您的應用程式，以自動化應用程式的分發。
GitHub Action 可以自動上傳您的應用程式，以自動化應用程式的分發。
