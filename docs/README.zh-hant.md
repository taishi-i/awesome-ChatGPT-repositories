 ...
 * [chatgpt_telegram_bot](https://github.com/karfly/chatgpt_telegram_bot) - 發現了這個驚人的電報機器人@karimiskakov. 只需在電報上加入他,
 ...
 * [whatsapp-gpt](https://github.com/danielgross/whatsapp-gpt) - #4. 整合chatgpt與Telegram和Whatsapp. 你可以在Telegram中建立一個由chatgpt動力的機器人,
 ...
 * [OpenChatKit](https://github.com/togethercomputer/openchatkit) - 只有一個例外? gh: demo:
 ...
 * [GPT-4-LLM](https://github.com/instruction-tuning-with-gpt-4/gpt-4-llm) - 這項工作呈現了 gpt-4-llm:這個數據集用于指示調節拉馬模型,
 ...
 * [babyagi](https://github.com/yoheinakajima/babyagi) - 系統使用openAI和pineconeAPIs來創建,優先,執行任務. 這個系統背後的主意是,它建立任務以先前任務的結果和預定義目標為基礎.
