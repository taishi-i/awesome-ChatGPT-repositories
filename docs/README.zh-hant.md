...
**CLIs**
 * [herdr](https://github.com/herdrdev/herdr) - 您的编码代理程序运行时间
...
**Others**
 * [loopx](https://github.com/huangruiteng/loopx) - 長期代理控制平面，用於Codex、Claude Code和其他工具的持久、受管工作。
 * [atlas](https://github.com/pacifio/atlas) - 代理商的源代碼控制。使用多個編碼代理商，跟踪他們的更改並在一個地方查詢它們。
 * [Maestro](https://github.com/runmaestro/maestro) - 代理人编排指挥中心
 ...
 * [squidgy-prompts](https://github.com/squidgyai/squidgy-prompts) - #chatgpt 和語言學習感興趣？我們剛剛發布了一組開源提示，以幫助學習者建立卡片組、挖掘句子、糾正語法、玩文字遊戲等等。可以單獨使用或在 @squidgiesapp 中使用。
 ...
 * [aicodeprep-gui](https://github.com/detroittommy879/aicodeprep-gui) - 具有良好UI的手術上下文工程，支持Windows、Mac、Linux、BSD等任何運行Python和Qt的地方。
 * [codexia](https://github.com/milisp/codexia) - 一個強大的GUI/IDE和Toolkit，適用於Codex CLI。分叉聊天+文件樹+提示記事本，Codex社區等。
 ...
 * [product-manager-prompts](https://github.com/deanpeters/product-manager-prompts) - 一個供產品經理使用代理人（如ChatGPT、Claude和Gemini）的生成式AI提示存儲庫
 ...
 * [pandas-ai](https://github.com/gventuri/pandas-ai) - 4、Anthropic、VertexAI）和RAG使數據分析變得對話式。
 ...
 * [quivr](https://github.com/quivrhq/quivr) - 4 turbo、Private、Anthropic、VertexAI、Ollama、LLMs與您的文檔（PDF、CSV等）和應用程序進行對話，您可以與用戶共享！這是一個本地和私人的替代方案，可替代OpenAI GPT和ChatGPT，由檢索增強生成技術驅動。
 * [smalltalk](https://github.com/tinystruct/smalltalk) - ChatGPT整合。@tinystruct
 * [maid](https://github.com/mobile-artificial-intelligence/maid) - llama.cpp 模型進行接口，並與 Ollama 和 OpenAI 模型進行遠程接口。
 * [pandas-ai](https://github.com/sinaptik-ai/pandas-ai) - 4、Anthropic、VertexAI）和RAG使數據分析變得對話式。
 ...
 * [nlux](https://github.com/nluxai/nlux) - Javascript庫
 ...
 * [deep-research-web-ui](https://github.com/anotiawang/deep-research-web-ui) - （支持DeepSeek R1）一個由人工智慧驅動的研究助手，通過結合搜索引擎、網絡抓取和大型語言模型，在任何主題上進行迭代、深入的研究。
 * [voice-pro](https://github.com/abus-aikorea/voice-pro) - Gradio WebUI 音頻處理，由 Whisper (OpenAI-Whisper, Faster-Whisper, Whisper-Timestamped) 驅動。功能包括 Voice Changer(RVC)、零樣本語音克隆 (E2, F5-TTS, CosyVoice)、YouTube 下載、聲音隔離(UVR5)、文本轉語音 (Edge-TTS)。
 * [hollama](https://github.com/fmaclen/hollama) - 一個最簡化的網頁UI，用於與Ollama（和OpenAI）伺服器進行對話
 ...
 * [MCP-SuperAssistant](https://github.com/srbhptl39/mcp-superassistant) - 將MCP帶到ChatGPT、Perplexity、Grok、Gemini、Google AI Studio、OpenRouter等等...
 ...
 * [LangBot](https://github.com/langbot-app/langbot) - Slack 🧩 集成了ChatGPT、DeepSeek、Dify、n8n、Claude、Google Gemini、xAI、PPIO、Ollama、阿里雲百煉、Silic
 * [open-codex](https://github.com/codingmoh/open-codex) - 完全開源的命令行人工智慧助理，靈感來自OpenAI Codex，支援本地語言模型。
 * [MuseBot](https://github.com/yincongcyincong/musebot) - 支援Telegram、Discord、Slack、Lark、企業微信等多個平台的AI聊天機器人，兼容OpenAI、Gemini、DeepSeek、Doubao和OpenRouter等多種LLM。提供智能對話、圖像生成、視頻創建等功能。無縫運行。
 ...
 * [thoughtdag](https://github.com/chenxiachan/thoughtdag) - 你的思維值得一張地圖：一個無限的畫布，LLM對話可以在其中成長為可編輯的思維圖。線條是上下文。
 ...
 * [ethgpt](https://github.com/xinbenlv/ethgpt) - 智能合約功能
 * [GodMode](https://github.com/smol-ai/godmode) - Llama2！我每天使用這個20次。
 ...
 * [browser-operator-core](https://github.com/browseroperator/browser-operator-core) - 瀏覽器操作者-具備內建多代理平台的AI瀏覽器！ChatGPT Atlas、Perplexity Comet、Dia和Microsoft CoPilot Edge Browser的開源替代方案。
 ...
 * [oh-my-taiyiforge](https://github.com/dong90/oh-my-taiyiforge) - AI 工作流自動化插件，用於智能代碼生成，與 Claude/Codex 一起使用
 ...
 * [lumen](https://github.com/jnsahaj/lumen) - 即時AI Git提交消息，從CLI中的Git更改摘要（無需API密鑰）
 * [cookiecutter-fastapi](https://github.com/arthurhenrique/cookiecutter-fastapi) - 使用Cookiecutter模板快速建立FastAPI项目，包括：机器学习、uv、Github Actions和Pytests。
 ...
 * [codex-profiles](https://github.com/ducksss/codex-profiles) - 命名為CODEX_HOME的配置文件和ChatGPT桌面窗口具有獨立的本地狀態，不複製令牌。
 * [shob](https://github.com/shobcoder/shob) - Shob - 一個提供高質量編碼和自動化工作的人工智能代理
 * [nika](https://github.com/supernovae-st/nika) - 代碼意圖 | 用於人工智慧的工作流程語言。一個文件，4個動詞，一個Rust二進制文件。本地優先，任何模型，AGPL-3.0。🦋
 * [codex-security](https://github.com/openai/codex-security) - OpenAI的Codex安全CLI和TypeScript SDK用於查找、驗證和修復安全漏洞。 npm: https://www.npmjs.com/package/@openai/codex-security
 * [EchoBird](https://github.com/edison7009/echobird) - 一键安装+模型切换：克劳德代码，Codex CLI（OpenAI），Grok Build（xAI），Kimi Code（Moonshot），Qwen Code，Aider，OpenCode，MiMo Code（小米），ZCode（Z.AI），OpenClaw，Pi，OpenScience，Vibe-Trading，克劳德桌面（3P配置文件），ChatGPT桌面，OpenCode桌面
 * [google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) - 控制Gmail、Google日曆、文件、表格、幻燈片、聊天、表單、任務、搜索和驅動器與AI-全面的Google Workspace MCP服務器和CLI工具
 ...
 * [TokenDagger](https://github.com/m4thyou/tokendagger) - OpenAI的TikToken高性能實現。
 * [LiteCommands](https://github.com/rollczi/litecommands) - ☄️ LiteCommands - Velocity、Bukkit、Paper、BungeeCord、Minestom、Sponge、Fabric、JDA和未來實現的指令框架。
 ...
 * [ai-cookbook](https://github.com/daveebbelaar/ai-cookbook) - 提供開發人員建立人工智慧系統的示例和教程
 ...
 * [chinese-llm-benchmark](https://github.com/jeinlee1991/chinese-llm-benchmark) - chatglm6b 等開源大模型，多維度能力評測。不僅提供能力評分排行榜，也提供所有模型的原始輸出結果！
 ...
 * [searchGPT](https://github.com/michaelthwan/searchgpt) - OpenAI API的有依據的搜索引擎（即具有來源參考）。它支持網絡搜索、文件內容搜索等。
 ...
 * [brainrot.js](https://github.com/brainrotjs/brainrot.js) - 在腦部形式中生成文本到視頻的工具。從您喜愛的名人那裡學習任何主題 😼。
 * [AIaW](https://github.com/nitrorcr/aiaw) - AI作为工作空间 - 精心設計的 AI (LLM) 客戶端。全功能，輕量級；支持多工作區、插件系統、跨平台、本地優先+實時雲同步、Artifacts
 * [uni-api](https://github.com/yym68686/uni-api) - 這是一個統一管理LLM API的專案。它可以通過統一的API接口調用多個後端服務，將它們統一轉換為OpenAI格式，並支持負載平衡。目前支持的後端服務包括：OpenAI。
 * [paperless-gpt](https://github.com/icereed/paperless-gpt) - 使用LLMs和LLM Vision（OCR）來處理無紙化-ngx-由人工智慧驅動的文件數位化
 * [anon-kode](https://github.com/dnakov/anon-kode) - 使用任何LLMs進行編碼
 ...
 * [dyad](https://github.com/dyad-sh/dyad) - Bolt替代品 🌟 如果你喜歡，請給個星星！
 ...
 * [quick-start-guide-to-llms](https://github.com/sinanuozdemir/quick-start-guide-to-llms) - "大型語言模型快速入門指南"的官方存儲庫
 ...
 * [markstream-vue](https://github.com/simon-he95/markstream-vue) - 為AI應用程序提供多框架流式Markdown渲染器：Vue/Nuxt、React/Next.js、Svelte和Angular，配備Mermaid、KaTeX、Shiki、Monaco、安全HTML和低抖動更新。
 * [screenpipe](https://github.com/screenpipe/screenpipe) - YC（S26）| 每天24小時記錄您的屏幕並連接到您的代理。本地、私密、安全。連接到OpenClaw、Hermes代理和100多個應用程式。
 * [imcodes](https://github.com/im4codes/imcodes) - 代理人的即時通訊。共享代理人上下文和記憶，監督執行，跨AI提供商的代理人審計。
 * [agent-qa](https://github.com/vostride/agent-qa) - 為軟體團隊打造的自我改進QA代理人。具有記憶的測試工具。使用自然語言編寫網頁和移動應用的測試。代理人QA從每次運行中學習，適應UI變化，並在發布之前捕捉回歸問題。
 * [Raven](https://github.com/evermind-ai/raven) - 採用EverOS建立的以記憶為先、自我改進的代理器，搭載MiroThinker強大的深度研究和推理功能。
 ...
 * [langchat](https://github.com/tycoding/langchat) - Claude 等大模型），Java 生態下 AI 大模型產品解決方案，快速構建企業級 AI 知識庫、AI 機器人應用
 * [ExtractThinker](https://github.com/enoch3712/extractthinker) - ExtractThinker是一個針對LLMs的文件智能庫，提供ORM風格的互動，用於靈活且強大的文件工作流程。
 ...
 * [gpustack](https://github.com/gpustack/gpustack) - 管理 GPU 集群以運行 AI 模型
 ...
 * [zen-mcp-server](https://github.com/beehiveinnovations/zen-mcp-server) - 以上所有] 聯合運作的力量。
 ...
 * [sglang](https://github.com/sgl-project/sglang) - SGLang是一個快速服務框架，適用於大型語言模型和視覺語言模型。
 ...
 * [gpt-tokenizer](https://github.com/niieani/gpt-tokenizer) - GPT-4。具有額外功能的 OpenAI tiktoken 的移植版本。
 ...
 * [openai](https://github.com/azure-samples/openai) - 所有Azure OpenAI樣本的存儲庫，補充OpenAI食譜。
 * [openai-java](https://github.com/openai/openai-java) - OpenAI API 的官方 Java 库
 * [deepseek4j](https://github.com/pig-mesh/deepseek4j) - 深度搜索 Java SDK
 ...
 * [chat-api](https://github.com/ai365vip/chat-api) - OpenAI 接口聚合管理，我們致力於提供優質的API接入服務，讓您可以輕鬆集成先進的AI模型至您的產品和服務。
 * [attorch](https://github.com/bobmcdear/attorch) - PyTorch的神經網絡模塊的子集，使用OpenAI的Triton用Python編寫。PyTorch的神經網絡模塊的子集，使用OpenAI的Triton用Python編寫。
 ...
 * [PRarena](https://github.com/aavetis/prarena) - 這個存儲庫跟踪由OpenAI、GitHub和其他公司的頂級軟件工程師編碼代理人打開並合併的PR。每3小時更新一次。
 ...
 * [omniai](https://github.com/ksylvest/omniai) - OmniAI標準化了多個AI供應商的API，如OpenAI的Chat GPT、Mistral的LeChat、Claude的Anthropic、Google的Gemini和DeepSeek的Chat。
 ...
 * [Machine-Learning-Goodness](https://github.com/aurimas13/machine-learning-goodness) - AGI的有用信息以及帶有提示的代碼或片段/腳本/任務。
 ...
 * [flutter_chatgpt_api](https://github.com/coskuncay/flutter_chatgpt_api) - Dart中的ChatGPT
 ...
 * [rinna_gpt-neox_ggml-lora](https://github.com/yukaryavka/rinna_gpt-neox_ggml-lora) - japanese-gpt-neox…” [gpt-neox]模型。
 ...
 * [spring-chatgpt-sample](https://github.com/azure-samples/spring-chatgpt-sample) - Java堆棧的ChatGPT樣本
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextwebteam/chatgpt-next-web) - MacOS）。
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextweb/chatgpt-next-web) - MacOS）。
 ...
 * [chatgpt-tarot-divination](https://github.com/dreamhunter2333/chatgpt-tarot-divination) - AI 算命，占卜，塔羅牌，姓名五格，周公解夢，生辰八字，梅花易數
