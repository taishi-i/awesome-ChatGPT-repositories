 ...
 * [promptable](https://github.com/cfortuner/promptable) - JavaScriptでLLMアプリを構築してください。🧑‍💻 🧑‍💻 🧑‍💻 🚀 🚀 🚀
 ...
 * [squidgy-prompts](https://github.com/squidgyai/squidgy-prompts) - #chatgpt と言語学習に興味はありますか？私たちは、学習者がデッキを構築し、文をマイニングし、文法を修正し、単語ゲームをプレイするためのオープンソースのプロンプトセットをリリースしました。単独で使用することも、@squidgiesapp で使用することもできます。
 ...
 * [gpt4free](https://github.com/xtekky/gpt4free) - 3.5スクリプトを提供します。
 ...
 * [pandas-ai](https://github.com/gventuri/pandas-ai) - 4、Anthropic、VertexAI）とRAGを使用して、データ分析を対話形式にします。
 ...
 * [quivr](https://github.com/quivrhq/quivr) - 4 turbo、Private、Anthropic、VertexAI、Ollama、LLMsを使用して、ドキュメント（PDF、CSVなど）やアプリとチャットできます。ユーザーと共有できる！ OpenAI GPTやChatGPTに対するローカルでプライベートな代替です。検索増強生成によってパワードされています。
 * [smalltalk](https://github.com/tinystruct/smalltalk) - ChatGPT ベースのチャットモジュールです。
 * [maid](https://github.com/mobile-artificial-intelligence/maid) - llama.cppモデルとローカルでインターフェースするためのクロスプラットフォームのFlutterアプリであり、また、OllamaとOpenAIモデルとリモートでインターフェースするためのものです。
 * [pandas-ai](https://github.com/sinaptik-ai/pandas-ai) - 4、Anthropic、VertexAI）とRAGを使用して、データ分析を対話形式にします。
 ...
 * [nlux](https://github.com/nluxai/nlux) - Javascriptライブラリ
 ...
 * [Auto-Gmail-Creator](https://github.com/ai-to-ai/auto-gmail-creator) - Flask、ML、AI、GPT、自動化、スクレイピングに関してはお気軽にお問い合わせください。
 ...
 * [LangBot](https://github.com/rockchinq/langbot) - Agentプラットフォームをサポート
 ...
 * [LangBot](https://github.com/langbot-app/langbot) - Slack 🧩 ChatGPT、DeepSeek、Dify、n8n、Claude、Google Gemini、xAI、PPIO、Ollama、阿里云百炼、Silicと統合
 ...
 * [GodMode](https://github.com/smol-ai/godmode) - Llama2への高速で完全なウェブアプリアクセス！私はこれを1日に20回使用しています。
 ...
 * [ai-commits-intellij-plugin](https://github.com/blarc/ai-commits-intellij-plugin) - Android Studio向けのAIコミット。
 ...
 * [json-translator](https://github.com/mololab/json-translator) - Argosに対応
 ...
 * [alpaca.cpp](https://github.com/rupeshs/alpaca.cpp) - Mac）
 ...
 * [chinese-llm-benchmark](https://github.com/jeinlee1991/chinese-llm-benchmark) - chatglm6bなどのオープンソースの大規模モデルをカバーし、多次元能力評価を提供します。能力スコアのランキングだけでなく、すべてのモデルの元の出力結果も提供します！
 ...
 * [Q-Bench](https://github.com/q-future/q-bench) - Qwen-VL-Plus + 16 OS MLLMs）低レベルビジョンと視覚品質評価におけるマルチモダリティLLM（MLLM）のベンチマーク。
 ...
 * [searchGPT](https://github.com/michaelthwan/searchgpt) - OpenAI APIに基づいたソース参照付きのグラウンデッド検索エンジン。Web検索、ファイル内容検索などをサポートしています。
 ...
 * [code-interpreter](https://github.com/e2b-dev/code-interpreter) - TS SDKを使用して、AI生成コード/コード解釈を実行するためのAIアプリを作成します。
 ...
 * [dyad](https://github.com/dyad-sh/dyad) - Boltの代替🌟 お気に入りの場合はスターを付けてください！
 ...
 * [zen-mcp-server](https://github.com/beehiveinnovations/zen-mcp-server) - 以上すべて] が一つとして機能する力。
 ...
 * [NeuroGPT](https://github.com/neurogen-dev/neurogpt) - チャットGPT API
 ...
 * [gpt-tokenizer](https://github.com/niieani/gpt-tokenizer) - GPT-4。OpenAIのtiktokenのポートに追加機能を備えています。
 ...
 * [flutter_chatgpt_api](https://github.com/coskuncay/flutter_chatgpt_api) - DartからChatGPTを使用してください。
 ...
 * [spring-chatgpt-sample](https://github.com/azure-samples/spring-chatgpt-sample) - Javaスタックを使用したChatGPTのサンプル
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextwebteam/chatgpt-next-web) - MacOS）。一つのボタンで自分自身のクロスプラットフォームChatGPTアプリを手に入れましょう。
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextweb/chatgpt-next-web) - MacOS）。一つのボタンで自分自身のクロスプラットフォームChatGPTアプリを手に入れましょう。
