 ...
 * [GPT-4-LLM](https://github.com/instruction-tuning-with-gpt-4/gpt-4-llm) - this is excellent! this paper presents gpt-4-llm: this dataset is used to instruction-tune llama models which results in enhanced zero-shot performance on new tasks.  project: ://t.co/cgijby4o9s
 ...
 * [babyagi](https://github.com/yoheinakajima/babyagi) - ai tasks agent with gpt"the system uses openai and pinecone apis to create, prioritize, and execute tasks. the main idea behind this system is that it creates tasks based on the result of previous tasks and a predefined objective."link 👇🏿 #gpt
 ...
 * [chatgpt_telegram_bot](https://github.com/karfly/chatgpt_telegram_bot) - while working on a #chatgpt bot for telegram.i found this amazing bot for telegram by @karimiskakov just add him on telegram and see the magic happens. @chatgpt_karfly_botgithub link to the bot page.
 ...
 * [OpenChatKit](https://github.com/togethercomputer/openchatkit) - most open-source instruct-tuned llms are still "no commercial use" (gpt4all, dolly, flan-alpaca, chatrwkv)tainted through llama license or openai non-compete tosis openchatkit (apache-2.0) the only exception?🐙 gh: 🔗 demo:
